      ...
      <div className="flex flex-col justify-center gap-10">
        <div className={`flex flex-col justify-center gap-10`}>
          ...
          <div className="flex flex-row justify-center gap-10">
            <button onClick={handleEvent} className={`${ isEvent ? 'move' : ''} md:text-3xl absolute bg-[#2a9d8f] shadow-xl hover:scale-110 transition-transform font-semibold text-xl p-4 px-10 rounded-xl font-Fira_Code text-white`}>Begin</button>
